...
const injectStyles = () => {
    ...
    s.textContent = `#ges-toast{position:fixed;top:20px;left:50%;transform:translateX(-50%);background:#1a1a1ae6;color:#fff;padding:8px 16px;border-radius:20px;font:13px/1.4 system-ui;z-index:2147483647;pointer-events:none;opacity:0;transition:opacity .2s}#ges-overlay{position:fixed;inset:0;background:rgba(0,0,0,.4);z-index:2147483646;opacity:0;pointer-events:none;transition:opacity .2s}#ges-overlay.open{opacity:1;pointer-events:auto}#ges-panel{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) scale(.95);width:min(320px,90vw);max-height:85vh;overflow-y:auto;background:#1e1e1e;padding:16px;border-radius:14px;box-shadow:0 10px 40px rgba(0,0,0,.5);font:13px/1.5 system-ui;z-index:2147483647;opacity:0;pointer-events:none;transition:.2s;color:#eee}#ges-overlay.open #ges-panel{opacity:1;transform:translate(-50%,-50%) scale(1);pointer-events:auto}.ges-title{font-weight:700;font-size:15px;margin:0 0 12px;color:#fff}.ges-g{background:#2a2a2a;padding:10px 12px;border-radius:10px;margin-bottom:10px}.ges-gt{font-size:10px;color:#888;text-transform:uppercase;font-weight:600;margin-bottom:8px;letter-spacing:.5px}.ges-r{display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:8px}.ges-r:last-child{margin-bottom:0}.ges-l{flex:1;color:#ddd}.ges-i,.ges-s{border:none;background:#333;color:#fff;border-radius:5px;padding:4px 8px;width:70px;text-align:right;font:inherit}.ges-s{width:auto;text-align:left}.ges-sw{position:relative;width:36px;height:20px;flex-shrink:0}.ges-sw input{opacity:0;width:0;height:0}.ges-sl{position:absolute;cursor:pointer;inset:0;background:#555;transition:.2s;border-radius:20px}.ges-sl:before{position:absolute;content:\"\";height:16px;width:16px;left:2px;bottom:2px;background:#fff;transition:.2s;border-radius:50%}input:checked+.ges-sl{background:#007AFF}input:checked+.ges-sl:before{transform:translateX(16px)}.ges-a{display:flex;justify-content:flex-end;gap:8px;margin-top:12px}.ges-btn{border:none;padding:8px 16px;border-radius:6px;cursor:pointer;font-weight:600;font-size:12px;background:#333;color:#fff;transition:.15s}.ges-btn:hover{background:#444}.ges-btn.p{background:#007AFF}.ges-btn.p:hover{background:#0066d6}`;
